...
{
  // Not implemented yet since it would require input from the user, which is
  // something this project is trying to avoid.
  // It can be assumed the implementation is working "correctly", it needs to
  // implement the 'season' parameter and be used to calculate the known values
